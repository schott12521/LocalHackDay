...
public class OrthoCamera extends OrthographicCamera {
    ...
    public OrthoCamera() {
        this(new VirtualViewport(MainGameClass.WIDTH, MainGameClass.HEIGHT));
    }
    ...
    public void resize() {
        VirtualViewport virtualViewport = new VirtualViewport(MainGameClass.WIDTH, MainGameClass.HEIGHT);
